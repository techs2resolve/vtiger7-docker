...
sed -i "s/max_execution_time = 30/max_execution_time = 0/" /etc/php/5.6/apache2/php.ini
sed -i 's/^error_reporting = .*/error_reporting = E_WARNING \& ~E_NOTICE \& ~E_DEPRECATED \& ~E_STRICT/' /etc/php/5.6/apache2/php.ini
sed -i "s/log_errors = On/log_errors = Off/" /etc/php/5.6/apache2/php.ini
