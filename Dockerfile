...
RUN apt-get install -y software-properties-common apt-utils && LC_ALL=C.UTF-8 add-apt-repository -y ppa:ondrej/php && apt-get update -y && apt-get install -y apache2 php5.6 libapache2-mod-php5.6 php5.6-mysql mysql-client php5.6-mcrypt php5.6-curl php5.6-gd php5.6-xml php5.6-zip openssl wget curl php5.6-imap php5.6-mbstring php5.6-soap vim libjpeg-dev
